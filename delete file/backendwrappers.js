...
async function deleteUserFavoriteLocations(user_id, place_id, id_token) {
    console.log(place_id)
    console.log(user_id)
    ...
    await axios.delete(`http://127.0.0.1:4000/user/remove/${user_id}`, data, config)
    return
}

export {getLocationReviews, postLocationReview, onLogin, deleteReview, favoriteLocation, getUserFavoriteLocations, deleteUserFavoriteLocations}
